...
const Admin = () => {
  ...
  const generateRscScript = () => {
    ...
    const script = [
      ...
      "/ip hotspot walled-garden ip add dst-host=" + hostname + " action=accept comment=\"WiFi Billing Portal\"",
      "/ip hotspot walled-garden add dst-host=" + hostname + " action=allow comment=\"WiFi Billing Portal\"",
